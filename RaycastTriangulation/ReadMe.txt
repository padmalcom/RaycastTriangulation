========================================================================
    KONSOLENANWENDUNG: RaycastTriangulation-Projektübersicht
========================================================================

Diese RaycastTriangulation-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre RaycastTriangulation-Anwendung besteht.


RaycastTriangulation.vcxproj
...
RaycastTriangulation.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen RaycastTriangulation.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
